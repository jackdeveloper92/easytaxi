...
<body>
            ...
            <div class="easytaxi-booking-form" data-aos="fade-up" data-aos-delay="500">
                <form id="easytaxi-booking-quote" class="styled" action="fare-quotes.php" method="POST">
                    <div class="row g-2 align-items-end" id="quoteRow">
                        ...
                        <!-- Submit Button -->
                        <div class="col-md-2">
                            <button type="submit" class="btn btn-custom w-100">Fare Quotes</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="modal fade" id="viewDetailsModal" tabindex="-1" aria-labelledby="viewDetailsModalLabel"
        ...
        <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header view-details-modal-header">
                ...
                <div class="modal-body">
                    <!-- Company & Vehicle Header -->
                    <div class="text-center mb-4">
                        <div class="company-logo mb-3">
                            <img src="assets/images/cars/cheapest-price.png" alt="City Taxis" class="img-fluid rounded"
                                style="max-height: 80px;">
                        </div>
                        <h4 class="fw-bold heading" id="modalCompanyName">City Taxis</h4>
                        ...
                        <div class="price-badge">
                            <span class="badge bg-success fs-6" id="modalPrice">£45.00</span>
                        </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-header bg-light">
                            <h6 class="mb-0"><i class="fas fa-cogs me-2"></i>Vehicle Specifications</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6 mb-3">
                                    <div class="spec-item text-center">
                                        ...
                                        <div class="fw-bold" id="modalVehicleType">Standard Estate</div>
                                ...
                                <div class="col-6 mb-3">
                                    <div class="spec-item text-center">
                                        ...
                                        <div class="fw-bold" id="modalCapacity">4 Passengers</div>
                                ...
                                <div class="col-6 mb-3">
                                    <div class="spec-item text-center">
                                        ...
                                        <div class="fw-bold" id="modalLuggage">2 Large + 1 Small</div>
                                        <small class="text-muted">Luggage Space</small>
                                    </div>
                                </div>
                                <div class="col-6 mb-3">
                                    <div class="spec-item text-center">
                                        <i class="fas fa-door-closed fa-2x text-primary mb-2"></i>
                                        <div class="fw-bold">4 Doors</div>
                    ...
                    <div class="alert alert-custom-info">
                        <div class="d-flex">
                            ...
                            <div>
                                <strong>Fixed Price Includes:</strong><br>
                                All taxes, tolls, and charges. No hidden fees.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-custom" id="bookVehicleBtn">
                        <i class="fas fa-check me-2"></i>Book This Vehicle
                    </button>
                </div>
            </div>
        </div>
                    ...
                    <div class="filter-card shadow-sm rounded-3">
                        ...
                        <div class="filter-body p-3">
                            ...
                            <div class="filter-group mb-4">
                                <h5 class="fw-semibold mb-3"><i class="fas fa-car me-2 text-primary"></i>Vehicle Type
                                </h5>
                            ...
                            <!-- Price Range Filter -->
                            <div class="filter-group mb-4">
                                <h5 class="fw-semibold mb-3 heading"><i
                                        class="fas fa-pound-sign me-2 text-primary"></i>Price Range</h5>
                            ...
                            <div class="filter-group">
                                <h5 class="fw-semibold mb-3 heading"><i
                                        class="fas fa-star me-2 text-primary"></i>Minimum Rating</h5>
                                <div class="rating-filter">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="ratingFilter" id="ratingAny"
                                            checked>
                    ...
                    <div class="quotes-list">
                        ...
                        <div class="quote-card mb-4 shadow-sm rounded-3">
                            <div class="row g-0 h-100">
                                <div
                                    class="col-md-3 d-flex align-items-center justify-content-center p-3 bg-light rounded-start">
                                    <div class="company-logo">
                                        <img src="assets/images/cars/cheapest-price.png" alt="City Taxis"
                                            class="img-fluid">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 p-4 text-center border-start">
                                    ...
                                    <button class="btn btn-custom w-100 mb-2 book-now-btn">
                                        <i class="fas fa-check me-2"></i>Book Now
                                    </button>
                                    <a href="#" class="btn btn-outline-primary w-100 view-details-btn">
                        ...
                        <div class="quote-card mb-4 shadow-sm rounded-3">
                            <div class="row g-0 h-100">
                                <div
                                    class="col-md-3 d-flex align-items-center justify-content-center p-3 bg-light rounded-start">
                                    <div class="company-logo">
                                        <img src="assets/images/cars/executive.png" alt="Executive Cars"
                                            class="img-fluid">
                                    </div>
                                </div>
                                <div class="col-md-6 p-4">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // Toastr Configuration - Position Changed
        toastr.options = {
            "closeButton": true,
            "debug": false,
            "newestOnTop": true,
        ...
        // 2. Multiple stops Functionality
        let stopCount = 1;
        ...
        if (addAnotherStopBtn) {
            addAnotherStopBtn.addEventListener('click', function () {
                ...
                `;
                    ...
                    toastr.warning('Maximum 8 stop points allowed');
                }
            });
        }
        ...
        if (saveStopsBtn) {
            saveStopsBtn.addEventListener('click', function () {
                ...
                if (stopInput && stops.length > 0) {
                    ...
                    toastr.success(`${stops.length} stops saved successfully`);
                } else if (stopInput) {
                    stopInput.value = '';
                    toastr.info('No stops to save');
                }
        ...
        // 5. View Details Modal Functionality
        document.querySelectorAll('.view-details-btn').forEach(button => {
            button.addEventListener('click', function (e) {
                e.preventDefault();

                const card = this.closest('.quote-card');
                const companyName = card.querySelector('h5').textContent;
                const price = card.querySelector('.text-primary').textContent;
                const vehicleType = card.querySelector('.vehicle-details .col-6:first-child span').textContent;
                const capacity = card.querySelector('.vehicle-details .col-6:nth-child(2) span').textContent;
                const luggage = card.querySelector('.vehicle-details .col-6:nth-child(3) span').textContent;
                ...
                document.getElementById('modalLuggage').textContent = luggage;
        ...
        // 6. Show Trust Toastr for ALL Book Now Buttons
        function showTrustToastr() {
        ...
        // 7. Attach trust toastr to ALL Book Now buttons
        ...
        // 8. Also attach to the specific Book This Vehicle button in modal
        document.getElementById('bookVehicleBtn').addEventListener('click', function (e) {
            e.preventDefault();
            showTrustToastr();
